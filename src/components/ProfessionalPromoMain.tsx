              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="flex items-start gap-4 bg-white/10 p-4 rounded-xl">
                    ...
                    <div>
                      <p className="font-semibold text-lg text-white">Безлимит: все расчёты сохраняются</p>
                      <p className="text-white/90 text-sm">В подписке от 1000₽/мес — рассчитывайте сколько угодно клиентов, все матрицы сохраняются и доступны во время сессий</p>
                    </div>
                  </div>
