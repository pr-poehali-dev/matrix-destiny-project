...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    rating: 5,
    text: 'Скептически относился к нумерологии, но решил попробовать. Был шокирован точностью — описание полностью совпало с моей личностью и жизненными задачами. PDF-отчёт очень подробный, перечитываю каждую неделю. Рекомендую всем!',
    date: '5 дней назад'
  },
  {
    name: 'Анна',
